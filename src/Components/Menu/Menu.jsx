...
function Menu() {
  ...
  const handleImageClick = (profile) => {
    ...
    console.log('Default Appliances:', profileDefaultAppliances[profile.name] || []);
    setSelectedProfileDefaultAppliances(profileDefaultAppliances[profile.name] || []); // Set default appliances
    setProfileSelect(false);
    console.log('Selected Appliances:', selectedProfileDefaultAppliances);
  };
